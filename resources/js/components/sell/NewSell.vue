                            ...
                            <div class="d-flex gap-2">
                                ...
                                <div>
                                    <div class="form-group">
                                        <button class="btn btn-brand-secondary btn-sm btn-brand" @click="newCustomer()"> <i class="fa fa-plus"></i> </button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="wiz-box d-flex flex-column h-100">
                                    ...
                                    <tr v-for="(cart, key) in carts">
                                        ...
                                        <td class="text-center w-125px">
                                            <div class="input-group input-group-sm">
                                                ...
                                                <span class="input-group-text bg-transparent" v-if="cart.unit">{{ cart.unit.title.substring(0,3) }}</span>
                                            </div>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <small class="price" style="display: none">
                                                {{cart.total_price = cart.quantity * (parseFloat(cart.sell_price) + parseFloat(cart.tax_amount))}}
                                            </small>
                            ...
                            <div class="wiz-card-footer">
                                <div class="d-flex justify-content-end">
                                    <table class="table table-sm table-bordered wiz-table w-auto">
                                        ...
                                        <tr>
                                            ...
                                            <td width="50%">
                                                <input type="number" v-model.number="summary.grand_total_price = grandTotalotalCartsValue" class="form-control form-control-sm" readonly>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                                ...
                                <div class="d-flex gap-1 justify-content-end pe-2">
                                    ...
                                    <div><a href="javascript:void(0)" v-on:click="archiveDrafts = true" class="btn btn-brand btn-brand-secondary btn-sm"><i class="fas fa-boxes"></i> {{drafts.length}} </a></div>
                                    <div><a href="javascript:void(0)" @click="archiveToDraft()" class="btn btn-brand btn-brand-warning btn-sm px-3" ><i class="fas fa-grip-lines-vertical"></i> </a></div>
                                    <div><a href="javascript:void(0);" @click="clearAll()" class="btn btn-brand btn-brand-danger btn-sm"><i class="bi bi-trash"></i></a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="sell-card-body sell-card-product-scroll">
                        <div class="p-2">
                            <div class="row g-3 justify-content-center all-products">
                                <div class="col-md-4 col-6" v-for="(product, index) in filteredProduct" v-if="product.current_stock_quantity > 0">
                                ...
                                <div class="mb-3" v-if="carts.length > 0">
                                    ...
                                    <div>
                                        <div class="table-responsive sell-invoice-table">
                                            <table class="table table-bordered table-sm text-center wiz-table mw-col-width-skip-first">
                                                <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{appConfig('app_currency')}}{{summary.grand_total_price | formatNumber}}
                                                    </td>
                                                </tr>
                                            ...
                                            <div class="table-responsive sell-invoice-table">
                                                <table class="table table-bordered text-center" width="100%" cellspacing="0">
                                                    ...
                                                    <tr v-for="(sell_produtc, index) in sell.sell_products">
                                                        ...
                                                        <td>{{appConfig('app_currency')}}{{sell_produtc.sell_price | formatNumber}}</td>
                                                        <td>{{appConfig('app_currency')}}{{sell_produtc.tax_amount | formatNumber}} <sub>( {{sell_produtc.tax_percentage}}% )</sub></td>
                                                        <td>{{sell_produtc.quantity}} {{sell_produtc.product.unit ? sell_produtc.product.unit.title : ''}}</td>
                                                        <td>{{appConfig('app_currency')}}{{(sell_produtc.total_price)}}</td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {{appConfig('app_currency')}}{{sell.sub_total | formatNumber}}
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {{appConfig('app_currency')}}{{sell.discount | formatNumber}}
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {{appConfig('app_currency')}}{{sell.grand_total_price | formatNumber}}
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <strong>
                                                                {{appConfig('app_currency')}}{{sell.paid_amount | formatNumber}}
                                                            </strong>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr v-if="">
                                                        ...
                                                        <td>
                                                            {{appConfig('app_currency')}}{{sell.due_amount | formatNumber}}
                                                        </td>
                                                    </tr>
                            ...
                            <div class="col-lg-4">
                                <div v-if="carts.length > 0" class="mb-5">
                                    ...
                                    <div class="mb-3">
                                        <table class="table table-bordered wiz-table">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-dark">{{appConfig('app_currency')}}{{grandTotalotalCartsValue}}</td>
                                            </tr>
                                            <tr>
                                    ...
                                    <div class="mb-3" v-if="cardInformationArea">
                                        <textarea v-model="summary.card_information"  class="form-control small" rows="3" placeholder="Card Information"></textarea>
                                    </div>


                                    <div class="d-flex gap-2">
                                        <div class="flex-grow-1"><a href="javasctipt:void(0)" class="btn btn-brand-secondary w-100" @click="paymentTypeCash">{{lang.cash}}</a></div>
                                        <div class="flex-grow-1"><a href="javasctipt:void(0)" class="btn btn-brand-dark-navy w-100" @click="paymentTypeCard">{{lang.card}}</a></div>
                                    </div>

                                    <div class="d-flex mt-2">
                                        <a href="javascript:void(0)" class="btn btn-brand btn-brand-primary w-100" v-if="!this.isSellStoreProcessing" @click="storeSell()">{{lang.confirm_payment}}</a>
                                        <a href="javascript:void(0)" class="btn btn-brand btn-brand-primary w-100" v-if="this.isSellStoreProcessing">
                                ...
                                <div class="mt-5" v-if="sell.invoice_id != null">
                                    <a v-bind:href="'../export/sell/print-invoice/id='+sell.id" @click="printInvoice" class="btn btn-brand-warning btn-brand w-100" target="_blank">
