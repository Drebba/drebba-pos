...
<script>
    export default {
        ...
        methods: {
            ...
            storeUnit: function () {
                axios.post('menu-unit', {unit: JSON.parse(JSON.stringify(this.newUnit))}).then((response) => {
                    this.newUnit.title = '';
            ...
            updateUnit: function () {
                axios.patch('menu-unit/' + this.unit.id , {unit: JSON.parse(JSON.stringify(this.newUnit))}).then((response) => {
                    this.newUnit.title = '';
            ...
            deleteUnit: function (id, index) {
                swal({
                    ...
                    if (willDelete) {
                        axios.delete('menu-unit/' + id).then((response) => {
