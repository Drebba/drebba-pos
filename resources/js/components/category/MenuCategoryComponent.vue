    ...
    export default {
        ...
        methods: {
            ...
            storeCategory: function () {
                axios.post('menu-category', {category: JSON.parse(JSON.stringify(this.newCategory))}).then((response) => {
            ...
            updateCategory: function () {
                axios.patch('menu-category/' + this.category.id , {category: JSON.parse(JSON.stringify(this.newCategory))}).then((response) => {
                    this.newCategory.title = '';
            ...
            deleteCategory: function (id, index) {
                swal({
                    ...
                    if (willDelete) {
                        axios.delete('menu-category/' + id).then((response) => {
