                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" id="title" value="{{old('title')}}" placeholder="{{__('pages.branch_name')}}" class="form-control form-control-lg"  required>
                                @if ($errors->has('title'))
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="contact_person" id="contact_person" value="{{old('contact_person')}}" placeholder="{{__('pages.contact_person')}}" class="form-control form-control-lg"  required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="phone" id="phone" value="{{old('phone')}}" placeholder="{{__('pages.phone_number')}}" class="form-control form-control-lg"  required>
                                @if ($errors->has('phone'))
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="address" id="address" value="{{old('address')}}" placeholder="{{__('pages.address')}}" class="form-control form-control-lg"  required>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea rows="5" name="short_description" id="short_description" placeholder="{{__('pages.short_description')}}" class="form-control form-control-lg">{{old('short_description')}}</textarea>
