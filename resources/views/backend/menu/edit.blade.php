...
@section('content')
    ...
    <div class="container-fluid">
        <form action="{{route('menu.update', [$product->id])}}" method="post" enctype="multipart/form-data" data-parsley-validate>
            @csrf
            @method('patch')
            ...
            <div class="wiz-card">
                ...
                <div class="wiz-card-header">
                    <h6 class="page-title">Edit Menu</h6>
                </div>
                <!-- Card Body -->
                    ...
                    <div class="row g-3">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" id="title" value="{{$product->title}}" placeholder="Menu name" class="form-control" aria-describedby="emailHelp">
                                @if ($errors->has('title'))
