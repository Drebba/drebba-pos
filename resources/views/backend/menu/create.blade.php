...
@section('content')
    ...
    <div class="container-fluid">
        <form action="{{route('menu.store')}}" method="post" enctype="multipart/form-data" data-parsley-validate>
            @csrf
            <div class="row">
                <div class="col-12">
                    <div class="wiz-card">
                        ...
                        <div class="wiz-card-header">
                            <h6 class="page-title">New Menu</h6>
                        </div>
                        <!-- Card Body -->
                            ...
                            <div class="row g-3">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="title" class="custom-label">Menu name <span class="text-danger">*</span></label>
                                        <input type="text" name="title" id="title" value="{{old('title')}}" placeholder="Menu name" class="form-control">
                                        @if ($errors->has('title'))
                                ...
                                {{-- <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="sku" class="custom-label">Menu SKU<span class="text-danger">*</span></label>
                                        <div class="input-group">
                                            <span class="input-group-text">{{get_option('purchase_invoice_prefix')}}</span>
                                            <input type="text" name="sku" id="sku" value="{{old('sku') ? old('sku') : $new_sku}}" maxlength="15" placeholder="Menu or sku code" class="form-control">
                                            @if ($errors->has('sku'))
